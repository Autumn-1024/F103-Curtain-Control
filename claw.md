# F103-Curtain-Control 项目记忆

## 项目信息
- **MCU**: STM32F103C8T6 (Cortex-M3, 64KB Flash, 20KB RAM)
- **本地路径**: C:\Users\Autumn\Desktop\F103-Curtain-Control
- **创建日期**: 2026-06-16
...
├── BSP/Inc/           ← bsp_*.h
├── BSP/Src/           ← bsp_*.c (led, key, uart, oled, rs485, curtain)
├── App/Inc/           ← app_task.h
├── App/Src/           ← app_task.c (业务逻辑)
├── MDK-ARM/           ← Keil工程
├── Output/            ← 编译产物
├── claw.md            ← 本文件
└── README.md
...
2. RS485使用HAL半双工自动方向管理，PA5实际为KEY1按键
3. KEY_UP是高电平有效，其他按键低电平有效

## 常用命令
```powershell
# 编译
& "C:\Program Files (x86)\MDK\core\UV4\UV4.exe" -b "C:\Users\Autumn\Desktop\F103-Curtain-Control\MDK-ARM\atk_f103c8t6.uvprojx" -o "C:\Users\Autumn\Desktop\F103-Curtain-Control\Output\build_log.txt" -j0

# 烧录
& "C:\Program Files (x86)\MDK\core\UV4\UV4.exe" -f "C:\Users\Autumn\Desktop\F103-Curtain-Control\MDK-ARM\atk_f103c8t6.uvprojx" -o "C:\Users\Autumn\Desktop\F103-Curtain-Control\Output\flash_log.txt" -j0
```
